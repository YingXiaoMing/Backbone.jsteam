define(function (require) {
    ...
    var ModalView = require("views/ModalTestView");
    ...
    var TestItemView = BaseView.extend({
        editHandler: function (obj) {
            ...
            var initData = function (items, itemname) {
                ...
                $.each(obj, function (name, item) {
                    ...
                    var realName = "";
                    if (itemname) {
                        realName = itemname + itemSeparator + name;
                    } else {
                        realName = name;
                    }
                    switch (itemType) {
                        case "select" :
                            ...
                            break;
                        case "editor":
                            var editor = KindEditor.create("#" + item.name, globalApp.editorPath);
